...
NEIGHBOURHOODS_KEY = "neighbourhoods"
DISTANCES_KEY = "distances"

def load_data(data_str):
    return json.loads(data_str)

def extract_neighbourhoods(data):
    return data[NEIGHBOURHOODS_KEY]
...
def generate_output(vehicle_name, result_path):
...
""" 
    ...
    neighbourhoods = extract_neighbourhoods(data)

    n_indices = ["n0", "n1", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9", "n10", "n11", "n12", "n13", "n14", "n15", "n16", "n17", "n18", "n19"]
    distances_2d_array = [neighbourhoods[index][DISTANCES_KEY] for index in n_indices]

    result_path = nearest_neighbor_algorithm(distances_2d_array)

    vehicle_name = "v0"
    output_json = generate_output(vehicle_name, result_path)
